  ...
  return (
    <main className="text-white">
      ...
      <div className="flex items-center justify-center h-32">
        <button className="rounded-xl border-2 w-48 top-0 right-0 m-[10%] hover:white hover:text-white hover:drop-shadow-md hover:shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f] hover:shadow-white transition-all ease-in-out duration-500" onClick={() => openFolder()}>Downloaded Videos</button>
      </div>
    </main>
  )
}
